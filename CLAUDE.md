...
- `is-playing` — reprodução em curso. Existe só para o CSS: combinada com `is-idle`, esconde o cursor sobre o quadro enquanto o vídeo corre, sem escondê-lo na pausa.
